defmodule InstabotWeb.UserLive.Login do
  @moduledoc false
    ...
    <Layouts.app flash={@flash}>
      <div class="mx-auto w-full sm:w-[400px]">
        <Card.render>
          ...
          <p :if={!@current_scope} class="text-sm mt-2 mb-4">
  ...
  defp local_mail_adapter? do
    Application.get_env(:instabot, Instabot.Mailer)[:adapter] == Swoosh.Adapters.Local
  end
end
